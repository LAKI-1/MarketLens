...
export default function SocialAuthButton({ provider, onGoogleCredential, onClick }: SocialAuthButtonProps) {
  if (provider === 'google') {
    return <GoogleButton onGoogleCredential={onGoogleCredential} />;
  }
